...
load([folderPath+filePath+"AmphetamineAAB_Data.mat"])
...
head_comp = [nose lear rear];
body_comp = [nose lear rear tail];
...
%%
writetable(datatable, [folderPath+filePath+"AmphetamineAAB_Data_downsampled_10FPS.csv"])
