...
id = readtable([folderPath+filePath+"MK801_Video_SubjNumbers_1.csv"], 'Delimiter',',');
vid = readtable([folderPath+filePath+"MK801_videoattributes.csv"], 'Delimiter',',');
...
%%
save([folderPath+filePath+"MK801AAB_Data_1"],'RawData');
...
id = readtable([folderPath+filePath+"MK801_Video_SubjNumbers_Replication.csv"], 'Delimiter',',');
vid = readtable([folderPath+filePath+"MK801_videoattributes_Replication.csv"], 'Delimiter',',');
...
%%
save([folderPath+filePath+"MK801AAB_Data_Replication"],'RawData');
