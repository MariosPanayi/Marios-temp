...
listofdatafolders <- c("SummationTest_Stage4_Day15")
...
nobin = c(S["ITI"], S["End"])
bin = c(S["PreCS"], S["Click"], S["Noise"], S["Tone"], S["Siren"], S["Pel_Banana"], S["Pel_Chocolate"], S["NoReward"], S["Tone_Flash"], S["Tone_Steady"], S["Siren_Flash"], S["Siren_Steady"], S["PreCS_Tone"], S["PreCS_ToneProbe"], S["PreCS_Siren"], S["PreCS_SirenProbe"])
...
savefilename <- "CI_Stage4_ProcessedData_pertrial_1sbins.csv"
