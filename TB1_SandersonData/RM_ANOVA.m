...
[~,WithinFactors.Interaction] = unique(WithinFactors);
WithinFactors.Interaction = categorical(WithinFactors.Interaction)
rm2 = fitrm(t2, 'Same1-Diff2 ~ Geno', 'WithinDesign',WithinFactors, 'WithinModel', 'Same_Diff*Bin');

Wsubj = ranova(rm2, 'WithinModel', 'Same_Diff*Bin')

multcompare(rm2,'Same_Diff', 'By', 'Bin', 'By','Geno')
multcompare(rm2,'Same_Diff', 'By', 'Bin')