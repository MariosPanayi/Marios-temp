---
title: "LYDopaminePaper_v4_redone"
...
As expected, amphetamine significantly increased locomotor activity (Amph `r anova_print$statistic$Amph`, Amph x Time `r anova_print$statistic$Amph_bin10mins`), an effect which was significantly reduced by LY354740 (Amph x LY354740 x Time `r anova_print$statistic$Amph_LY_bin10mins`, Amph x LY354740 `r anova_print$statistic$Amph_LY`). Specifically, LY354740 significantly reduced Amph induced hyperactivity 1-60 mins post injection (Amph/LY354740 vs Amph/Veh `r simple2_60_print$statistic$LY_Veh_Amph_X1`) but not 61-120 mins post injection (`r simple2_60_print$statistic$LY_Veh_Amph_X2`). In contrast, LY354740 alone did not affect locomotor activity (Veh/LY354740 vs Veh/Veh, 1-60 mins `r simple2_60_print$statistic$LY_Veh_Veh_X1`, 61-120 mins `r simple2_60_print$statistic$LY_Veh_Veh_X2`).
...
Peaksimple_print <- apa_print(pairs(Peaksimple, adjust = "tukey"))

Peaksimple2 <- emmeans(Peakanova, ~drug*rewardMagnitude)
Peaksimple2_print <- apa_print(contrast(Peaksimple2, by = "rewardMagnitude", interaction = "pairwise", adjust = "tukey"))
...
AUCsimple_print <- apa_print(pairs(AUCsimple, adjust = "tukey"))

AUCsimple2 <- emmeans(AUCanova, ~drug*rewardMagnitude)
AUCsimple2_print <- apa_print(contrast(AUCsimple2, by = "rewardMagnitude", interaction = "pairwise", adjust = "tukey"))
...
Latencysimple_print <- apa_print(pairs(Latencysimple, adjust = "tukey"))

Latencysimple2 <- emmeans(Latencyanova, ~drug*rewardMagnitude)
Latencysimple2_print <- apa_print(contrast(Latencysimple2, by = "rewardMagnitude", interaction = "pairwise", adjust = "tukey"))
...
simple_print_PrePost_Peak <- apa_print(contrast(simple, by = "drugs", interaction = "pairwise", adjust = "tukey"))
...
simple <- emmeans(anova, ~drugs*injectiontime)
simple_print_PrePost_AUC <- apa_print(contrast(simple, by = "drugs", interaction = "pairwise", adjust = "tukey"))
...
simple_print_Intenisty_Peak_Perc  <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimStrength)
simple_print_Intenisty_AUC_Perc <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimStrength)
simple_printt_Intensity_Latency_Perc <- apa_print(pairs(simple, adjust = "tukey"))
...
simple_print_Pulse_Peak_Perc <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimPulses)
simple_print_Pulse_AUC_Perc  <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimPulses)
simple_print_Pulse_Latency_Perc <- apa_print(pairs(simple, adjust = "tukey"))
...
simple_print <- apa_print(contrast(simple, method = "pairwise", adjust = "tukey"))
...
# simple_60_print <- apa_print(contrast(simple_60, by = "Amph", interaction = "pairwise", adjust = "tukey"))
# 
# simple2_60 <- emmeans(anova_60, ~Feeding*bin60mins)
# simple2_60_print <- apa_print(contrast(simple2_60, by = c("Feeding"), interaction = "pairwise", adjust = "tukey"))
...
simple <- emmeans(anova, ~stimStrength)
simple_print_Intensity_Pre_Peak <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimStrength)
simple_print_Intensity_Pre_AUC <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimStrength)
simple_print_Intensity_Pre_Latency <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimPulses)
simple_print_Pulses_Pre_Peak <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimPulses)
simple_print_Pulses_Pre_AUC <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimPulses)
simple_print_Pulses_Pre_Latency <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimStrength)
simple_print_Intensity_Post_Peak <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimStrength)
simple_print_Intensity_Post_AUC <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimStrength)
simple_print_Intensity_Post_Latency <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimPulses)
simple_print_Pulses_Post_Peak <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimPulses)
simple_print_Pulses_Post_AUC <- apa_print(pairs(simple, adjust = "tukey"))
...
simple <- emmeans(anova, ~stimPulses)
simple_print_Pulses_Post_Latency <- apa_print(pairs(simple, adjust = "tukey"))
```
