...
%% 01Baseline1
load('F:\Marios aFCV\GLRA_002\DataAnalysis\GLRA002_04BaselineData.mat');
...
saveData = {geno, sex, subj, CalibrationFactor, StimStrength, StimPulse,StimFreq,DALatency,DaMax, MaxFitIndex, pklocs, rsq, t50 };

writematrix('SaveMarios.xls', saveData)
