...
FILEPATH = 'C:\Users\mpanagi\Documents\GitHub\Marios-temp\GLRA003\GLRA003_RI60Day3.xlsx';
...
for subj = 1:totalSubj
    ...
    try
        ...
        for i = 1:length(figlist)
            saveas(figure(i), ['GLRA003_RI60Day3_Fig' num2str(i) '_' genotype '_' mouseid '_' fignames{1,i} '.png'])
        end
